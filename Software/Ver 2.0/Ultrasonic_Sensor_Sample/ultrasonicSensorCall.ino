 ...
 * 1. VCC, red→ Arduino 5V
 * 2. GND, black → Arduino GND
 * 3. RX, yellow (sensor input/trigger) → Microcontroller (TX)
 * 4. TX, white (sensor output/echo) → Microcontroller (RX)
 * 
...
// End of file ultrasonicSensorCall.ino
